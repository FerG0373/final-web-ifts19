...
<nav class="nav">
    <div class="nav-container">
        ...
        <button id="theme-toggle" aria-label="Cambiar tema">
            <!-- Ícono Luna -->
            <svg id="moon-icon" class="nav-login-theme" style="display: <?= $modoOscuro ? 'none' : 'inline' ?>;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30" height="30" fill="none" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                <path d="M21.752 15.002A9.72 9.72 0 0 1 18 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 0 0 3 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 0 0 9.002-5.998Z"/>
            </svg>
            <!-- Ícono Sol -->
                <svg id="sun-icon" class="nav-login-theme" style="display: <?= $modoOscuro ? 'inline' : 'none' ?>;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="33" height="33" fill="none" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
